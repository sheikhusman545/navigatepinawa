...
export default function AboutPage() {
  return (
    <main className="relative min-h-screen bg-white">
      ...
      {/* Hero Image Section */}
      <section className="relative h-[400px] w-full mt-20">
        <Image
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <h1 className="text-5xl md:text-6xl font-bold text-white uppercase text-center">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          {/* Activities */}
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Activities</h2>
